    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ fontSize: '24px', fontWeight: '700', color: '#F1F5F9', margin: '0 0 8px 0' }}>
            AI Workforce Solutions
          </h1>
          <p style={{ color: '#94A3B8', margin: 0, fontSize: '14px' }}>Dashboard Quản lý Tổng hợp</p>
        </div>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required
              ...
              style={{
                ...
                border: '1px solid rgba(148, 163, 184, 0.2)',
                borderRadius: '12px', color: '#F1F5F9', fontSize: '15px', outline: 'none', boxSizing: 'border-box'
              }}
            />
          </div>
          <div style={{ marginBottom: '24px' }}>
            <label style={{ display: 'block', marginBottom: '8px', fontSize: '14px', color: '#94A3B8' }}>Mật khẩu</label>
